                        ...
                        <div class="row">
                            <div class="col p-2 border">
                                ...
                                <div class="col p-2 text-center">
                                    ...
                                    <div class="row">
                                        <div class="me-2 mt-3 float pull-right">
                                            <span class="rounded-4 bg-gray p-2 text-right" style="width: 50%;">Hello. I have a question about your product details.May I ask a question?</span>
                                            <img src="{{ asset('img/Woman_1.jpeg') }}" class="rounded-circle border link-underline link-underline-opacity-0" style="height: 30px; width: 30px;" alt="">
                                        </div>
                                        <div class="ms-2 mt-3 float pull-left">
                                            <img src="{{ asset('img/shoppingcart.png') }}" class="rounded-circle border link-underline link-underline-opacity-0" style="height: 30px; width: 30px;" alt="">
                                            <span class="rounded-4 p-2 border-gray">Hello. Of course!</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
