...
<div class="container">
    ...
    <form action="#" method="post">
        ...
        <input type="radio" value="1" name="product_rating" id="rating1" class="fa-regular fa-star btn-warning" style="border-color:#071657">
        ...
        <input type="submit" class="btn text-white " value="Post" style="background-color: #071657; border-radius: 43px; width: 80px">
    </form>
</div>
