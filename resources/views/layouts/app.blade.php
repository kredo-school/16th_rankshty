...
<head>
    ...
    {{-- Stylesheet --}}
    <link rel="stylesheet" href="{{ asset('build/css/seller/style.css') }}">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    {{-- Search Bar Here. The serach will be deiplayed only if the user is logged in --}}
                    @auth
                        @if (!request()->is('admin/*'))
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    {{-- is('admin/*') -- also a method() -- is going to check for pattern,
                        ...
                        http://localhost/post/3/show -- this route does not a pattern
